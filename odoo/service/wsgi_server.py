...
def wsgi_xmlrpc(environ, start_response):
    ...
    """
    # print('VYTWSGI', environ, start_response)
    if environ['REQUEST_METHOD'] == 'POST' and environ['PATH_INFO'].startswith('/xmlrpc/'):
        ...
        # print('VYTWSGI 2', service, method, params, data)
        # _logger.info('VYTWSGI service ' + str(service))
        # _logger.info('VYTWSGI method ' + str(method))
        # _logger.info('VYTWSGI params ' + str(params))
        # _logger.info('VYTWSGI data ' + str(data))
        try:
